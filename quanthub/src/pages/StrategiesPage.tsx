  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on(
        ...
        () => {
          // Refetch strategies when there are changes
          fetchStrategies();
        }
      )
      .subscribe();
    ...
    <div className="min-h-screen w-screen flex flex-col bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      ...
      <main className="flex-1 px-4 py-12">
        ...
        <p className="text-lg text-gray-300 mb-12 text-center max-w-2xl mx-auto">
          Explore community-contributed quant trading strategies. Click on a
          strategy to view details, performance, and more.
        </p>
          ...
          <div className="text-center py-12">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-400 mb-6">
                Be the first to upload a quant trading strategy! Share your
                algorithms with the community.
              </p>
              <button
                onClick={handleUploadClick}
        ...
        <AuthNotification
          ...
          message="You need to be signed in to upload strategies. Please sign in to continue."
        />
        <style>{`
          .animate-fade-in {
